...
export default function App() {
  ...
  const vehicles = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1614729375290-b2a429db839b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzcGFjZSUyMHNodXR0bGUlMjByb2NrZXQlMjBsYXVuY2h8ZW58MXx8fHwxNzc1OTY2MTk5fDA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <audio
        ...
        preload="auto"
      >
        <source src="/src/imports/spaceOdyssey.mp3" type="audio/mpeg" />
      </audio>
      ...
      >
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-orange-950/20 via-transparent to-yellow-950/20" />
        </div>
        ...
        <motion.button
          ...
          onClick={toggleMute}
          className="absolute top-8 right-8 z-20 p-3 rounded-full bg-black/50 backdrop-blur-sm border border-orange-500/30 hover:bg-black/70 hover:border-orange-500/50 transition-all"
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <motion.h1
            ...
            className="text-5xl md:text-7xl mb-6 tracking-tight bg-gradient-to-r from-orange-400 via-yellow-300 to-orange-400 bg-clip-text text-transparent"
          >
            TERMINAL GUIDANCE
          </motion.h1>
          ...
          <motion.button
            ...
            className="bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-500 hover:to-orange-600 text-white px-10 py-4 rounded-sm text-lg inline-flex items-center gap-3 transition-all shadow-lg shadow-orange-900/50"
          >
            Begin Training
        ...
        >
          <span className="text-sm text-orange-400/80 tracking-widest uppercase">Scroll to Explore</span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
            transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
            className="w-px h-12 bg-gradient-to-b from-orange-400 to-transparent"
          />
        </motion.div>
      </motion.section>
      ...
      <section className="py-24 px-6 relative z-20 bg-black">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl mb-4">The Career Progression</h2>
            ...
            {vehicles.map((vehicle, index) => (
              ...
              >
                <div className="aspect-[16/10] overflow-hidden">
                  ...
                  className={`absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent ${vehicle.url ? 'cursor-pointer' : ''}`}
                />
                </div>

                <div className="absolute bottom-0 left-0 right-0 p-8">
                  <div className="text-orange-400 text-sm tracking-widest mb-2 uppercase">{vehicle.stage}</div>
                ...
                <motion.div
                  ...
                  className="absolute top-6 right-6 w-12 h-12 bg-gradient-to-br from-orange-600 to-orange-700 flex items-center justify-center"
                >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.button
              ...
              className="bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-500 hover:to-orange-600 text-white px-10 py-4 rounded-sm text-lg inline-flex items-center justify-center gap-3 transition-all shadow-lg shadow-orange-900/50"
            >
              Get Started
              <ArrowRight className="w-5 h-5" />
            </motion.button>
            ...
            <motion.button
              ...
              className="border-2 border-orange-500/50 hover:border-orange-500 hover:bg-orange-500/10 text-white px-10 py-4 rounded-sm text-lg transition-all"
            >
              Watch Trailer
            </motion.button>
          </div>
      ...
      {/* Footer */}
      <footer className="border-t border-orange-900/30 py-8 px-6 bg-gradient-to-b from-black to-zinc-950">
